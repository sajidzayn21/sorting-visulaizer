...
function SortingChart() {
    ...
    return (
        <div className="mt-4 mb-4 flex flex-col items-center">
            <h1 className="md:text-6xl sm:text-5xl text-4xl lg:text-7xl font-bold font-sans mx-auto mb-6 text-center w-full" >Sorting Visualizer</h1>
            
            <div className="flex flex-wrap justify-center gap-3 mb-6">
                <button
                    onClick={() => changeAlgorithm("bubble_sort")}
                    className={`bg-[#3a3939] text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "bubble_sort" ? "bg-[#616060] " : "hover:bg-[#6f6969]"
                    } transition-all`}
                >
                    Bubble Sort
                </button>
                <button
                    ...
                    className={`bg-[#3a3939] text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "insertion_sort" ? "bg-[#616060]" : "hover:bg-[#6f6969]"
                    } transition-all`}
                >
                    Insertion Sort
                </button>
                <button
                    ...
                    className={`bg-[#3a3939] text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "selection_sort" ? "bg-[#616060]" : "hover:bg-[#6f6969]"
                    } transition-all`}
                >
                    Selection Sort
                </button>
                <button
                    ...
                    className={`bg-[#3a3939] text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "merge_sort" ? "bg-[#616060]" : "hover:bg-[#6f6969]"
                    } transition-all`}
                >
                    Merge Sort
                </button>
                <button
                    ...
                    className={`bg-[#3a3939] text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "quick_sort" ? "bg-[#616060]" : "hover:bg-[#6f6969]"
                    } transition-all`}
                >
                    Quick Sort
                </button>
                <button
                    ...
                    className={`bg-[#3a3939] text-white px-5 py-3 rounded-3xl ${
                        sortingState.algorithm === "radix_sort" ? "bg-[#616060]" : "hover:bg-[#6f6969]"
                    } transition-all`}
                >
                    Radix Sort
                </button>
            ...
            <div className="max-w-3xl w-full">
                ...
                <div className="flex items-center gap-4 max-w-3xl mb-8">
                    ...
                    <select
                        ...
                        defaultValue="slow"
                        className="ml-auto bg-[#3a3939] px-2 py-2 rounded-md cursor-pointer outline-none focus:ring ring-turquoise-dark disabled:brightness-75 disabled:cursor-default"
                    >
                ...
                <div>
                    ...
                    <div className="overflow-auto">
                        <table className="w-full text-left">
                            <thead>
                                <tr>
                                    <th className="px-4 border-r border-[#6f6969] " rowSpan={2}>
                                        Algorithm
                                    </th>
                                    <th className="px-4 border-r border-[#6f6969] text-center " colSpan={3}>
                                        Time Complexity
                                    </th>
                                    <th className="px-4">Space Complexity</th>
                                </tr>
                                <tr className="border-b border-[#6f6969]">
                                    <th className="px-4 pb-2">Best</th>
                                    <th className="px-4 pb-2">Average</th>
                                    <th className="px-4 pb-2 border-r border-[#6f6969]">Worst</th>
                                    <th className="px-4 pb-2">Worst</th>
                                </tr>
                            </thead>
                            <tbody>
                                {Object.keys(algorithmInfos).map((key, i) => (
                                    <tr key={i} className="hover:bg-[#6f6969] whitespace-nowrap">
                                        <td className={`px-4 py-1 ${i === 0 ? "pt-2" : ""} border-r border-[#6f6969]`}>{algorithmInfos[key].name}</td>
                                        ...
                                        <td className={`px-4 py-1 ${i === 0 ? "pt-2" : ""} border-r border-[#6f6969]`}><span className={`px-1.5 py-0.5 rounded-md bg-${algorithmInfos[key].time_complexity.worst[1]}`}>{algorithmInfos[key].time_complexity.worst[0]}</span></td>
